...
public class UserController {
    ...
    String subUserToFeed(@PathVariable final String userId, @PathVariable final String feedId) {
        keyspaceRepository.useKeyspace(ProjectConstants.KEYSPACE.env());
    ...
    String unSubUserToFeed(@PathVariable final String userId, @PathVariable final String feedId) {
        keyspaceRepository.useKeyspace(ProjectConstants.KEYSPACE.env());
